...
const STATUS_MAP: Record<string, StatusConfig> = {
  ...
  unused:       { classes: "bg-[oklch(0.65_0.2_142)]/12 text-[oklch(0.38_0.16_142)] border-[oklch(0.65_0.2_142)]/25", icon: <CheckCircle2 className="h-3 w-3" /> },
  ...
  redeemed:     { classes: "bg-primary/10 text-primary border-primary/20", icon: <CheckCircle2 className="h-3 w-3" /> },
